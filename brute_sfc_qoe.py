    ...
    def select(self):
        ...
        while True:
            ...
            if best_c:
                ...
                #print("Placement of VNFs: ", best_c)
                energy.update(best_c, self.state, self.idletime, self.vnf_id_collection, self.capaVNFs)
                ...
                self.energy_OIA = energy.energy_OIA_mode(best_c, self.E_vnf, self.E_IDLEvnf, 
                                                         self.state, self.vnf_id_collection, self.capaVNFs)
                #print("Energy of OIA: ", round(self.energy_OIA, 0))
                self.total_OIA.append(self.energy_OIA)
                #print("===========================================\n")
                # ===================================================================================================
